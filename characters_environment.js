...
var gameConfig={
  ...
  gravity: 1,
  gravityEnemy: 0.59999999999999999999999999999999999999999999999999999999999999999999999999999999999999999,
  jump:-55,
...
function game(){
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Press Play game button to Start and Play the Game", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
...
function changeGameStatud(character){
  if( gamestatus=="start" && noseX !=""  && gameConfig.status==="start") {
    document.getElementById("IsLoaded").innerHTML="Game is loaded"
    world_start.play();
